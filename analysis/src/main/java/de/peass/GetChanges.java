...
public class GetChanges {
	...
	public static void main(final String[] args) throws JAXBException, ParseException {
		final Options options = OptionConstants.createOptions(OptionConstants.OUT, OptionConstants.URL, OptionConstants.DATA, OptionConstants.DEPENDENCYFILE, OptionConstants.EXECUTIONFILE);
