...
//      final File executeCommands = new File(resultFolder, "execute-" + VersionComparator.getProjectName() + ".sh");
      generateExecuteCommands(dependencies, changedTests, experimentid, System.out);
   ...
   public static void generateExecuteCommands(final Dependencies dependencies, final ExecutionData changedTests, final String experimentId, final PrintStream goal) throws IOException {
      RunCommandWriter writer = new RunCommandWriterSlurm(goal, experimentId, dependencies);
