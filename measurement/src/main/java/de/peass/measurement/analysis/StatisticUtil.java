...
public class StatisticUtil {
   ...
   public static boolean areEqual(DescriptiveStatistics statisticsAfter, DescriptiveStatistics statisticsBefore, double significance, double maxDelta) {
      ...
      // System.out.println(statisticsAfter.getMean() + " " + statisticsBefore.getMean());
      // double avg = (statisticsAfter.getMean() + statisticsBefore.getMean()) / 2;
      // double omega = Math.abs(statisticsAfter.getMean() - avg);
      //
      // System.out.println(omega);
      // double tValue = getTValue(statisticsAfter, statisticsBefore, omega);
      // double tValue2 = getTValue(statisticsAfter, statisticsBefore, -omega);
      //
      //
      //
      // boolean rejectAddition = Math.abs(tValue) > criticalValue;
      // boolean rejectSubstraction = Math.abs(tValue2) > criticalValue;
      // System.out.println("Krit: " + criticalValue + " " + tValue + " " + tValue2 + " " + rejectAddition + " " + rejectSubstraction);
      //
      // return rejectAddition && rejectSubstraction;
   }
